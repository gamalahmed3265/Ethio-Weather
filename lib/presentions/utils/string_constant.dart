class StringConstant {
  ...
  static String appVersion = "2022.7.19";

  static String appShortDescription =
      "Ethiopia Weather application provide current, hourly & daily weather information.";

  static String appDesignedandDevelopedBy = "Designed and Developed By";
  ...
  static String googlePlayStoreUrl =
      "https://play.google.com/store/apps/details?id=com.ethio.weather";
}
